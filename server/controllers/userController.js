...
function updateUser(request, respond){
    ...
    var user = new User(parseInt(request.params.id), request.body.userName, request.body.userEmail, null, request.body.userContact, request.body.userGender, request.body.userBio, null);
